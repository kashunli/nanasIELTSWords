...
def main() -> int:
    ...
    try:
        ...
        for record in selected:
            ...
            connection.execute("INSERT INTO word_items VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", (record["stable_id"], record["item_uuid"], collection_code, record["chapter"], record["position"], record["headword"], meaning["part_of_speech"], meaning["meaning_en"], meaning["meaning_zh"], word_audio, record["transcript_status"], meaning.get("meaning_status", "ai_draft"), "asr", "asr"))
